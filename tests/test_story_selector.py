...
CAREER_STATS = {
    1: [
        {"season": "2022", "sh_vs_expected": 1.50},
        {"season": "2023", "sh_vs_expected": 1.45},
        {"season": "2024", "sh_vs_expected": 1.68},
    ],
    2: [
        {"season": "2022", "sh_vs_expected": 0.82},
...
def test_injured_player_excluded(tmp_path):
    sel = StorySelector(
        ...
        career_stats=CAREER_STATS,
        headlines=[],
        unavailable_players={1},  # Hot Shooter unavailable
        history_path=str(tmp_path / "h.json"),
    )
    story = sel.select()
