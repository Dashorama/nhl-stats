...
from scripts.llm_narrator import LLMNarrator, _trim_faceoffs, _trim_shooters, _trim_tracking

SHOOTERS = [
    {
        "player_id": 1,
        "player_name": "Hot Shooter",
        "team_abbrev": "EDM",
        "goals": 63,
        "xg": 37.4,
        "gax": 25.6,
...
class TestNarrateEndToEnd:
    ...
    def test_rejects_unknown_team(self):
        narrator = LLMNarrator()
        result = self._call(narrator, _valid_llm_json(subject_type="team", subject_id="XXX"))
        assert result is None
